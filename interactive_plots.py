...
def dfUniprot_dfGOSlim(dfUniprot = DataFrame([]), dfGOSlim = DataFrame([])):    
    ...
    z1 = widgets.ToggleButton(value=False,description='Save',disabled=False,button_style='',
                             tooltip='Description')
    w1 = widgets.VBox([g1, n1, b1, c1, d1, f1, e1, o1, z1])
    def box1(a1, b1, c1, d1, e1, f1, g1, n1, o1, z1):
        #print((a, b, c, d, e, f, g, h))
    ...
    www = Button(layout=Layout(width='80%', height='15px'), disabled=True)
    www.style.button_color = 'white'
    uuu = Button(layout=Layout(width='80%', height='5px'), disabled=True)
    uuu.style.button_color = 'black'
    graficas = {'BAR CHART': (HBox([a]), HBox([w, out])),
...
yyy = Button(layout=Layout(width='80%', height='5px'), disabled=True)
yyy.style.button_color = 'red'
xxx = Button(layout=Layout(width='80%', height='5px'), disabled=True)
