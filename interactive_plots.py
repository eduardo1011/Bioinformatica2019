...
def dfUniprot_dfGOSlim(dfUniprot = DataFrame([]), dfGOSlim = DataFrame([])):    
    ...
    c = widgets.Dropdown(options=list(range(1,51)),value=10,description='size_x:',disabled=False,
                        layout=Layout(width='95%', height='25px'))
    d = widgets.Dropdown(options=list(range(1,51)),value=10,description='size_y:',disabled=False,
                        layout=Layout(width='95%', height='25px'))
    e = widgets.Dropdown(options=list(range(1,51)),value=10,description='xlabel:',disabled=False,
                        layout=Layout(width='95%', height='25px'))
    f = widgets.Dropdown(options=list(range(1,51)),value=10,description='size_title:',disabled=False,
                        layout=Layout(width='95%', height='25px'))
    g = widgets.Dropdown(options=list(range(1,51)),value=10,description='size_bartxt:',disabled=False,
                        layout=Layout(width='95%', height='25px'))
    #h = widgets.Dropdown(options=list(colors.keys()),description='color:',disabled=False) # colors
    h = widgets.Dropdown(options=common_colors,value='brown',description='color:',disabled=False,
    ...
    n = widgets.Dropdown(options=['GO', 'Term', 'Short_Term'],value='Term',
                         ...
                         layout=Layout(width='95%', height='25px'))
    o = widgets.Dropdown(options=[0, 0.25, 0.5, 0.75] + list(range(1,51)),value=3,description='sep:',disabled=False,
                        layout=Layout(width='95%', height='25px'))
    ...
    f2 = widgets.Dropdown(options=['none', 'label'],value='none',description='node_label:',disabled=False,
                         layout=Layout(width='95%', height='25px'))
    g2 = widgets.Dropdown(options=common_colors,value='black',description='col_in_min:',disabled=False,
                         layout=Layout(width='95%', height='25px'))
    h2 = widgets.Dropdown(options=common_colors,value='blue',description='col_in_max:',disabled=False,
                         layout=Layout(width='95%', height='25px')) # colors
    i2 = widgets.Dropdown(options=common_colors,value='red',description='col_node:',disabled=False,
                         layout=Layout(width='95%', height='25px'))
    ...
    l2 = widgets.Dropdown(options=escala_uno,value=0.8,description='node_alpha:',disabled=False,
                         layout=Layout(width='95%', height='25px'))
    m2 = widgets.Dropdown(options=list(range(1,51)),value=7,description='label_size:',disabled=False,
                         layout=Layout(width='95%', height='25px'))
    ...
    d3 = widgets.Dropdown(options=list(range(1,51)),value=8,description='xticks_size:',disabled=False,
                            layout=Layout(width='95%', height='25px'))
    e3 = widgets.Dropdown(options=list(range(1,51)),value=8,description='yticks_size:',disabled=False,
                            layout=Layout(width='95%', height='25px'))
    f3 = widgets.Dropdown(options=list(range(1,51)),value=12,description='ylabel_size:',disabled=False,
                            layout=Layout(width='95%', height='25px'))
    ...
    b4 = widgets.Dropdown(options=list(range(1,51)),value=10,description='fontsize:',disabled=False,
                            layout=Layout(width='95%', height='25px'))
    ...
    i5 = widgets.Dropdown(options=[False, 'bold'],value=False,description='font_sets:',disabled=False,
                            layout=Layout(width='95%', height='25px'))
    j5 = widgets.Dropdown(options=list(range(1,51)),value=15,description='size_sets:',disabled=False,
                            layout=Layout(width='95%', height='25px'))
    ...
    l5 = widgets.Dropdown(options=[False, 'bold'],value=False,description='font_inter:',disabled=False,
                            layout=Layout(width='95%', height='25px'))
    m5 = widgets.Dropdown(options=list(range(1,51)),value=15,description='size_inter:',disabled=False,
                            layout=Layout(width='95%', height='25px'))
