...
arboll_ASVs = open('AnexosITS/clustal_ASVs_Tree.txt', 'r')
...
DisMat2_OTUs, unifrac_matrix_OTUs, id_samples_OTUs = table_to_distances2(DATAFRAME_PHYLOGENETIC_OTUs, tree_OTUs,unweighted_unifrac)
